        ...
        <div class=" p-1 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                <table class=" table-fixed w-full text-sm text-center text-gray-500 dark:text-gray-400">
                    ...
                    <tbody v-for="earning in earning" :key="earning">
                        <tr
                            ...
                            <td class="py-4 px-6 flex justfy-between truncate">
                                <div class="mb-4">
                                    <Link :href="route('earning.edit', {id: earning.id})" class="">
...
function destroy(id) {
    if (confirm("Você realmente deseja excluir o item?")) {
        form.delete(route('earning.destroy', id));
    }
}
